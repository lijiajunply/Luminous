...
func TestCreateAndFindAll(t *testing.T) {
	...
	if err := repo.Create(school); err != nil {
...
func TestFindByCode(t *testing.T) {
	...
	found, err := repo.FindByCode("FIND")
	if err != nil {
...
func TestFindEnabled(t *testing.T) {
	...
	repo.Create(&model.School{Code: "ON", Name: "On", Website: "https://a.edu", Features: nil, Enabled: true})
	repo.Create(&model.School{Code: "OFF", Name: "Off", Website: "https://b.edu", Features: nil, Enabled: false})

	enabled, err := repo.FindEnabled()
	if err != nil {
...
func TestUpdate(t *testing.T) {
	...
	repo.Create(&model.School{Code: "UPD", Name: "Old", Website: "https://old.edu", Features: nil, Enabled: true})
...
func TestDelete(t *testing.T) {
	...
	repo.Create(&model.School{Code: "DEL", Name: "Delete Me", Website: "https://del.edu", Features: nil, Enabled: true})

	if err := repo.Delete("DEL"); err != nil {
		t.Fatalf("Delete: %v", err)
	}

	_, err = repo.FindByCode("DEL")
	if err == nil {
...
func TestPersistenceAcrossInstances(t *testing.T) {
	...
	repo1.Create(&model.School{Code: "PERSIST", Name: "Persist", Website: "https://p.edu", Features: nil, Enabled: true})

	repo2, err := NewJSONSchoolRepository(path)
	if err != nil {
		t.Fatal(err)
	}
	found, err := repo2.FindByCode("PERSIST")
	if err != nil {
